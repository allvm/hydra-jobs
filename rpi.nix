...
{
  linuxCommon = mapTestOnCross lib.systems.examples.raspberryPi linuxCommon;
  small = mapTestOnCross lib.systems.examples.raspberryPi small;
  compilers = mapTestOnCross lib.systems.examples.raspberryPi compilers;


  bootstrapTools = bootstrapTools.armv6l;
}
